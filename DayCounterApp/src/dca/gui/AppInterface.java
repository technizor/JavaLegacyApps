...
**/	private void buildElements()
	{
		buildElement(title, 			0, 0, 	4, 1, 	9, 5, 	1, 0);
		buildElement(windowButtons,		4, 0,	1, 1,	1, 5,	0, 0);
		buildElement(currentTimeLabel, 	0, 1, 	1, 1, 	0, 15, 	3, 3);
		buildElement(monthLabel, 		1, 1, 	1, 1, 	0, 0, 	0, 0);
		buildElement(dayLabel, 			2, 1, 	1, 1, 	0, 0, 	0, 0);
		buildElement(yearLabel, 		3, 1, 	1, 1, 	0, 0, 	0, 0);
		buildElement(fromLabel, 		0, 2, 	1, 1, 	20, 25, 0, 0);
		buildElement(monthBox1, 		1, 2, 	1, 1, 	20, 0, 	0, 0);
		buildElement(dayBox1, 			2, 2, 	1, 1, 	30, 0, 	0, 0);
		buildElement(yearBox1, 			3, 2, 	1, 1, 	30, 0, 	0, 0);
		buildElement(submit, 			4, 1, 	1, 3, 	0, 25, 	0, 0);
		buildElement(toLabel, 			0, 3, 	1, 1, 	0, 25, 	0, 0);
		buildElement(monthBox2, 		1, 3, 	1, 1, 	0, 0, 	0, 0);
		buildElement(dayBox2, 			2, 3, 	1, 1, 	0, 0, 	0, 0);
		buildElement(yearBox2, 			3, 3, 	1, 1, 	0, 0, 	0, 0);
		buildElement(resultLabel, 		0, 4, 	1, 1, 	0, 0, 	0, 0);
		buildElement(result, 			1, 4, 	4, 1, 	0, 0, 	0, 0);
		buildElement(currentTime,		1, 4, 	4, 1, 	0, 0, 	0, 0);
	}
